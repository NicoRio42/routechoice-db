...
const targetEnvironmentFile = join('src', 'environments', `environment.${environment}.js`);

const devEnvironmentFile = join('src', 'environments', 'environment.dev.js');
const environmentFile = join('src', 'environments', 'environment.js');
