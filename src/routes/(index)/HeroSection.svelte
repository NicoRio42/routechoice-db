...
<section class="grow flex justify-center items-center gap-4 py4 m0 w-full">
	...
	>
		<div class="flex flex-col gap-4 items-center justify-center px-4 text-center">
			...
			<p class="text-5">
				Routechoice DB is a complete toolbox for Sprint Orienteering Analysis.
				It helps the <a href="https://www.facebook.com/coursedorientation.clubfrance">French Orienteering Team</a>
